...
export function useNotifications() {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/hotel/notifications`, {
        headers: {
  ...
  const markAsRead = async (notificationId: string) => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/hotel/notifications/${notificationId}/read`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${session.access_token}`,
          'Content-Type': 'application/json'
  ...
  const markAllAsRead = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/hotel/notifications/mark-all-read`, {
        method: 'PATCH',
        headers: {
